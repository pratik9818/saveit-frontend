    ...
    <div className="bg-gray-50 min-h-screen text-gray-800">
      ...
      <header className="bg-gradient-to-r from-blue-500 to-purple-500 text-white py-20 px-4 text-center">
        ...
        <p className="text-lg md:text-xl mb-6">
          Save and organize all your content—text, images, videos, and more—in
          one place.
        </p>
        <div className="space-x-4">
          <button
            onClick={redirectToLogin}
            className="bg-white text-blue-500 font-bold px-6 py-3 rounded shadow hover:bg-gray-100"
          >
            Get Started
          </button>
        </div>
      ...
      <footer className="bg-gray-800 text-white py-10 px-4 text-center">
        ...
        <div className="space-x-4">
          <a
            onClick={() => naviagte("/app/privacy-policy")}
            className="hover:underline"
          >
            Privacy Policy
          </a>
          <a
            href="https://mail.google.com/mail/?view=cm&fs=1&to=healthyfoodie4@gmail.com"
            target="_blank"
