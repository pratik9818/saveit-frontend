...
export default function FragmentUploadStatus() {
  ...
  const [uploadedFragmentCountValue, setUploadedFragmentCountValue] =
    useRecoilState(uploadedFragmentCount);
  const [fragmentCountValue, setFragmentCountValue] = useRecoilState(
    selectedFragmentCountToUpload
  );
  ...
  return (
    fragmentCountValue > 0 && (
      <div className="fixed top-0 left-0 right-0 z-10">
        <div
          ref={statusBar}
          className="w-[99%] mx-auto h-[5px] bg-gray-200 overflow-hidden"
        >
          <div
